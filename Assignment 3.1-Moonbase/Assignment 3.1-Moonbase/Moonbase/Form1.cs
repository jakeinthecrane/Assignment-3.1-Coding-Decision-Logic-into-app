...
namespace Moonbase
{
    ...
    {   // User position tracker class is declared. It is a read-only field.
...

        {
            ...
            //the method is called. Porpose of this eventHandler is to track the users position by tracking the mouse.
        ...
        //THE LOG FILE IS FOUND IN THE DEBUG FOLDER WITHIN THE MOONBASE REPO FILE "User_position_log"
